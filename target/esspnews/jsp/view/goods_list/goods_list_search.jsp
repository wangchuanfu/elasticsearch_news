...
<link href="https://cj.j1.com/css/product2.css" rel="stylesheet" type="text/css" />
<link href="<%=WebURLParams.CJ_URL %>/css/view/2list.css" rel="stylesheet" type="text/css" />
...
<div id="listpagecontainer">
	 <div id="listpagecontent">
		<div class=detailnav>
			<SPAN><A href="<%=WebURLParams.HOME_PAGE_URL %>/">健一网首页</A></SPAN> <SPAN class=arrow>&gt;</SPAN><c:if test="${!empty  topName}">&nbsp;<a href="<%=WebURLParams.LIST_PAGE_URL %>/p-${topCId }.html" target="_blank">${topName }</a>&nbsp;&gt;&nbsp;</c:if>
			<c:if test="${catalog.proCatalogLevel eq 2 }">
				<SPAN><A href="<%=WebURLParams.LIST_PAGE_URL %>/p-${secId }.html">${secName}</A></SPAN>
		...
		<div class="listpageleft">
				...
				<div class="listpageChooseBox"><input type="hidden" id="noticeGoodsIdHidden"/><input type="hidden" id="noticeProductIdHidden"/><input type="hidden" id="goodsNoHidden"/>
					<c:forEach items="${navList}" var="thdCata">
						<c:choose>
							...
							<c:otherwise>
								<h3>
									<a href="<%=WebURLParams.LIST_PAGE_URL %>/p-${thdCata.proCatalogId }.html">${thdCata.proCatalogName }<span></span>
									</a>
								</h3>
							</c:otherwise>
						</c:choose>
			...
			<!-- 同类商品推荐st -->
			<div >
			 	<jsp:include page="/jsp/view/goods_list/similar_goods_recommend.jsp"></jsp:include>
			</div> 
			<!-- 同类商品推荐ed -->
			<!-- ##########################   左边        ############################### -->
		...
		<div class="listpageright">
			<!-- 相关推荐 -->
			 <jsp:include page="/jsp/view/goods_list/product_catalog_suggest.jsp"/>
			<!--促销活动 促销信息 -->
			 <jsp:include page="/plistSearch/promotionGoods/${catalog.proCatalogId }.html"/>  
			<!--排序-->
			<!-- 商品属性 -->
		 	<jsp:include page="/jsp/view/goods_list/goods_list_filter_condition.jsp"/>
			<!-- 商品属性  end-->
			<!-- 商品列表 start -->
			 <jsp:include page="/jsp/view/goods_list/goods_list_catalog.jsp">
...
<!-- 		</div> -->
		...
		<div class="listlink">
			<ul>
				...
				<jsp:include page="/recommend/1/4.html"  flush="true" />
				<div class="clear"></div>
			</ul>
			<ul>
				<li class="listdh">专科用药：</li>
				<jsp:include page="/recommend/1/5.html"   flush="true"/>
				<div class="clear"></div>
			</ul>
			<ul>
				<li class="listdh">分&nbsp;&nbsp;&nbsp;&nbsp;类：</li>
				<jsp:include page="/recommend/getTwoCatalog/${catalog.proCatalogId}.html"  flush="true" />
				<div class="clear"></div>
			</ul>
		</div>
		<div class="list_recommed">
			...
			<div class="listerrorad">
				<a href="<%=WebURLParams.LIST_PAGE_URL %>/p-11000-2515.html"><img alt="三九" src="https://img.j1.com/images/images1308/error/lg_01.gif"></a> <a href="<%=WebURLParams.LIST_PAGE_URL %>/p-11000-2535.html"><img alt="中美史克" src="https://img.j1.com/images/images1308/error/lg_02.gif"></a> <a href="<%=WebURLParams.LIST_PAGE_URL %>/p-11000-2823.html"><img alt="西安杨森" src="https://img.j1.com/images/images1308/error/lg_03.gif"></a> <a href="<%=WebURLParams.LIST_PAGE_URL %>/p-11000-2545.html"><img alt="惠氏" src="https://img.j1.com/images/images1308/error/lg_04.gif"></a> <a href="<%=WebURLParams.LIST_PAGE_URL %>/p-11000-2533.html"><img alt="云南白药" src="https://img.j1.com/images/images1308/error/lg_05.gif"></a> <a href="<%=WebURLParams.LIST_PAGE_URL %>/p-15200-2579.html"><img alt="欧姆龙" src="https://img.j1.com/images/images1308/error/lg_06.gif"></a> <a
					href="<%=WebURLParams.LIST_PAGE_URL %>/p-15200-2589.html"><img alt="三诺" src="https://img.j1.com/images/images1308/error/lg_07.gif"></a> <a href="<%=WebURLParams.LIST_PAGE_URL %>/p-15200-2657.html"><img alt="雅培" src="https://img.j1.com/images/images1308/error/lg_08.gif"></a> <a href="<%=WebURLParams.LIST_PAGE_URL %>/p-16100-2659.html"><img alt="美素佳儿" src="https://img.j1.com/images/images1308/error/lg_09.gif"></a> <a href="<%=WebURLParams.LIST_PAGE_URL %>/p-16100-3689.html"><img alt="雀巢" src="https://img.j1.com/images/images1308/error/lg_10.gif"></a> <a href="<%=WebURLParams.SEARCH_PAGE_URL %>/%25E6%25B1%25A4%25E8%2587%25A3%25E5%2580%258D%25E5%2581%25A5/1/1-0-0-1/ss.html"><img alt="汤成倍健" src="https://img.j1.com/images/images1308/error/lg_11.gif"></a> <a
					href="<%=WebURLParams.SEARCH_PAGE_URL %>/%25E5%2585%25BB%25E7%2594%259F%25E5%25A0%2582/1/1-0-0-1/ss.html"><img alt="养生堂" src="https://img.j1.com/images/images1308/error/lg_12.gif"></a> <a href="<%=WebURLParams.SEARCH_PAGE_URL %>/%25E5%2596%2584%25E5%25AD%2598/1/1-0-0-1/ss.html"><img alt="善存" src="https://img.j1.com/images/images1308/error/lg_13.gif"></a> <a href="<%=WebURLParams.SEARCH_PAGE_URL %>/%25E5%2586%25AC%25E9%2598%25BF%25E9%2598%25BF%25E8%2583%25B6/1/1-31183-0-1/31183.html"><img alt="东阿阿胶" src="https://img.j1.com/images/images1308/error/lg_14.gif"></a> <a href="<%=WebURLParams.LIST_PAGE_URL %>/p-18100-2611.html"><img alt="杜蕾斯" src="https://img.j1.com/images/images1308/error/lg_15.gif"></a> <a href="<%=WebURLParams.LIST_PAGE_URL %>/p-18100-2615.html"><img alt="杰士邦" src="https://img.j1.com/images/images1308/error/lg_16.gif"></a> <a
					href="<%=WebURLParams.LIST_PAGE_URL %>/p-4774.html"><img alt="博士伦" src="https://img.j1.com/images/images1308/error/lg_17.gif"></a> <a href="<%=WebURLParams.LIST_PAGE_URL %>/p-4704.html"><img alt="海昌" src="https://img.j1.com/images/images1308/error/lg_18.gif"></a> <a href="<%=WebURLParams.LIST_PAGE_URL %>/p-11000-2515.html"><img alt="三九" src="https://img.j1.com/images/images1308/error/lg_01.gif"></a> <a href="<%=WebURLParams.LIST_PAGE_URL %>/p-11000-2535.html"><img alt="中美史克" src="https://img.j1.com/images/images1308/error/lg_02.gif"></a>
			</div>
		</div>
	</div>
</div>
